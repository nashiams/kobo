...
fn build_emits_kobo_summary_and_downstream_rejects_mutated_hash() {
    let upstream = TestProject::new("ecosystem-summary-upstream");
    upstream.write(
        "Cargo.toml",
        r#"[package]
name = "upstream_kobo"
...
"#,
    ...
    let tampered_consumer = TestProject::new("ecosystem-summary-tampered-body-consumer");
...
"#,
    ...
    let summary_consumer = TestProject::new("ecosystem-summary-liveness-consumer");
...
"#,
    ...
    let unrelated_consumer = TestProject::new("ecosystem-summary-unrelated-consumer");
...
"#,
    ...
    let text_only_consumer = TestProject::new("ecosystem-summary-text-only-consumer");
...
"#,
    ...
    let local_type_consumer = TestProject::new("ecosystem-summary-local-type-consumer");
...
"#,
    ...
    let other_crate_consumer = TestProject::new("ecosystem-summary-other-crate-type-consumer");
...
"#,
    ...
    let downstream = TestProject::new("ecosystem-summary-downstream");
    downstream.write(
        "Cargo.toml",
        &format!(
            r#"[package]
...
"#,
    ...
    assert_contains(
        &inspect.combined(),
        "K0126",
        "summary hash mismatch should use the ecosystem summary diagnostic",
    );
...
fn summary_usage_is_serialized_in_exact_witness_with_obligation_facts() {
    let upstream = TestProject::new("ecosystem-summary-witness-upstream");
    upstream.write(
        "Cargo.toml",
        r#"[package]
...
"#,
    ...
    let downstream = TestProject::new("ecosystem-summary-witness-downstream");
    downstream.write(
        "Kobo.toml",
        &format!(
            r#"[ecosystem]
...
fn test_sim_rejects_stale_summary_before_writing_exact_witness() {
    let upstream = TestProject::new("ecosystem-summary-stale-test-upstream");
    upstream.write(
        "Cargo.toml",
        r#"[package]
...
"#,
    ...
    let downstream = TestProject::new("ecosystem-summary-stale-test-downstream");
    downstream.write(
        "Kobo.toml",
        &format!(
            r#"[ecosystem]
