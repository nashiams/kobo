...
fn kobo_add_edits_cargo_metadata_first_and_keeps_metadata_optional() {
    let project = TestProject::new("ecosystem-kobo-add");
    project.write(
        "Cargo.toml",
        r#"[package]
name = "ecosystem-kobo-add"
version = "0.1.0"
edition = "2021"
"#,
    );
...
fn kobo_add_promised_registry_crate_without_explicit_version() {
    let project = TestProject::new("ecosystem-kobo-add-serde-json");
    project.write(
        "Cargo.toml",
        r#"[package]
name = "ecosystem-kobo-add-serde-json"
version = "0.1.0"
edition = "2021"
"#,
    );
...
fn third_party_registry_index_drives_add_and_metadata_packages() {
    let project = TestProject::new("ecosystem-third-party-registry");
    project.write(
        "Cargo.toml",
        r#"[package]
name = "ecosystem-third-party-registry"
version = "0.1.0"
edition = "2021"
"#,
    );
...
fn untrusted_or_incomplete_registry_metadata_is_rejected() {
    let project = TestProject::new("ecosystem-untrusted-registry");
    project.write(
        "Cargo.toml",
        r#"[package]
name = "ecosystem-untrusted-registry"
version = "0.1.0"
edition = "2021"
"#,
    );
...
fn registry_metadata_package_checksum_mismatch_is_rejected() {
    let project = TestProject::new("ecosystem-registry-checksum-mismatch");
    project.write(
        "Cargo.toml",
        r#"[package]
name = "ecosystem-registry-checksum-mismatch"
version = "0.1.0"
edition = "2021"
"#,
    );
...
fn registry_types_package_must_pin_usable_declaration_before_validation() {
    let project = TestProject::new("ecosystem-registry-types-without-declaration");
    project.write(
        "Cargo.toml",
        r#"[package]
name = "ecosystem-registry-types-without-declaration"
version = "0.1.0"
edition = "2021"
"#,
    );
...
fn registry_metadata_compatibility_uses_consuming_dependency_version() {
    let project = TestProject::new("ecosystem-registry-consuming-version");
    project.write(
        "Cargo.toml",
        r#"[package]
name = "ecosystem-registry-consuming-version"
version = "0.1.0"
edition = "2021"
...
fn registry_source_path_must_stay_inside_workspace_and_match_crate_identity() {
    let project = TestProject::new("ecosystem-registry-source-identity");
    project.write(
        "Cargo.toml",
        r#"[package]
name = "ecosystem-registry-source-identity"
version = "0.1.0"
edition = "2021"
"#,
    );
...
fn kobo_add_supports_workspace_dependency_section_and_path_source() {
    let project = TestProject::new("ecosystem-kobo-add-workspace");
    project.write(
        "Cargo.toml",
        r#"[workspace]
members = ["app"]
...
fn kobo_add_can_target_workspace_member_manifest() {
    let project = TestProject::new("ecosystem-kobo-add-member");
    project.write(
        "Cargo.toml",
        r#"[workspace]
members = ["app"]
...
fn kobo_add_types_and_adapter_record_optional_kobo_metadata() {
    let project = TestProject::new("ecosystem-add-types-adapter");
    project.write(
        "Cargo.toml",
        r#"[package]
name = "ecosystem-add-types-adapter"
version = "0.1.0"
edition = "2021"
"#,
    );
...
fn builtin_thiserror_types_package_carries_declaration_hash() {
    let project = TestProject::new("ecosystem-add-types-thiserror");
    project.write(
        "Cargo.toml",
        r#"[package]
name = "ecosystem-add-types-thiserror"
version = "0.1.0"
edition = "2021"
"#,
    );
...
fn init_from_cargo_merges_existing_project_without_source_rewrite() {
    let project = TestProject::new("ecosystem-init-from-cargo");
    project.write(
        "Cargo.toml",
        r#"[package]
...
fn add_supports_dev_build_and_target_dependency_sections() {
    let project = TestProject::new("ecosystem-add-section-targeting");
    project.write(
        "Cargo.toml",
        r#"[package]
name = "ecosystem-add-section-targeting"
version = "0.1.0"
edition = "2021"
"#,
    );
...
fn migrate_cargo_deps_imports_dependency_shape_as_optional_ecosystem_debt() {
    let project = TestProject::new("ecosystem-migrate-cargo-deps");
    project.write(
        "Cargo.toml",
        r#"[package]
...
fn migrate_cargo_deps_imports_workspace_member_dependencies() {
    let project = TestProject::new("ecosystem-migrate-workspace-deps");
    project.write(
        "Cargo.toml",
        r#"[workspace]
members = ["app", "worker"]
...
fn migrate_cargo_deps_expands_workspace_member_globs() {
    let project = TestProject::new("ecosystem-migrate-workspace-globs");
    project.write(
        "Cargo.toml",
        r#"[workspace]
members = ["crates/*"]
