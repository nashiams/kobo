...
pub(super) fn entries() -> Vec<DiagnosticRegistryEntry> {
    ...
    vec![
        ...
        entry(
            ...
            "parent-child back-pointer tree can leak",
            "Parent and child links can keep each other alive forever.",
        ...
        entry(
            ...
            "Kobo reports this early because Rust requires an owned indirection or a redesigned structure.",
            Solver,
            Note,
            Always(Note),
            NoModeDependency,
