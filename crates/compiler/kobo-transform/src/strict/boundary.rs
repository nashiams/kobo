...
///
/// Reference: P3 Task 3.3. Invariant C05: emit FACTS (StrictBoundaryFact),
/// never KDiagnostic.
...
/// violation found. Invariant C05: emit FACTS, not diagnostics.
///
...
/// Invariant C05: emits StrictBoundaryFact, never KDiagnostic.
