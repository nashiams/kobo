...
fn queue_loop_infers_template_invariant() {
    let project = TestProject::new("translation-loop-invariant-queue");
...
fn renamed_queue_loop_proves_the_same_template() {
    let project = TestProject::new("translation-loop-invariant-renamed");
    let artifact_path = emit_artifact(
        &project,
...
fn branch_leak_reaching_back_edge_rejects_proof() {
    let project = TestProject::new("translation-loop-invariant-branch-leak");
...
fn continue_before_discharge_rejects_back_edge_proof() {
    let project = TestProject::new("translation-loop-invariant-continue");
...
fn early_break_before_discharge_rejects_loop_proof() {
    let project = TestProject::new("translation-loop-invariant-break");
    let source_file = project.main_file(&loop_control_flow_source(
...
fn break_edges_are_loop_exits_not_back_edges() {
    let project = TestProject::new("translation-loop-invariant-break-exit");
    let artifact_path = emit_artifact(
        &project,
...
fn labeled_break_targets_the_named_outer_loop() {
    let project = TestProject::new("translation-loop-invariant-labeled-break");
    let artifact_path = emit_artifact(
        &project,
...
fn mixed_labeled_branch_control_does_not_fabricate_back_edges() {
    let project = TestProject::new("translation-loop-invariant-mixed-labeled-control");
    let artifact_path = emit_artifact(
        &project,
...
fn while_loop_records_back_edge_facts() {
    let project = TestProject::new("translation-loop-invariant-while");
    let artifact_path = emit_artifact(
        &project,
...
fn stream_loop_infers_template_before_user_invariant() {
    let project = TestProject::new("translation-loop-invariant-stream");
...
fn retry_loop_infers_template_before_user_invariant() {
    let project = TestProject::new("translation-loop-invariant-retry");
    let source = protocol_loop_source(
        "retry_loop_case",
        "RetryPolicy",
        "policy",
...
fn transaction_loop_infers_template_before_user_invariant() {
    let project = TestProject::new("translation-loop-invariant-transaction");
    let source = protocol_loop_source(
...
fn service_request_loop_infers_reply_template_before_user_invariant() {
    let project = TestProject::new("translation-loop-invariant-service");
    let source = protocol_loop_source(
...
fn inferred_protocol_template_uses_registry_metadata() {
    let project = TestProject::new("translation-loop-invariant-template-registry");
    let artifact_path = emit_artifact(
        &project,
...
fn mixed_protocol_loop_records_template_evidence_per_binding() {
    let project = TestProject::new("translation-loop-invariant-multi-template");
    let artifact_path = emit_artifact(
        &project,
...
fn missing_binding_template_evidence_is_rejected_after_rehash() {
    let project = TestProject::new("translation-loop-invariant-multi-template-tamper");
    let artifact_path = emit_artifact(
        &project,
...
fn explicit_user_invariant_records_user_tier_and_preservation() {
    let project = TestProject::new("translation-loop-invariant-user");
    let artifact_path = emit_artifact(
        &project,
...
fn explicit_user_invariant_is_scoped_to_named_loop() {
    let project = TestProject::new("translation-loop-invariant-user-scope");
    let artifact_path = emit_artifact(
        &project,
...
fn explicit_user_invariant_rejects_pending_entry_obligation() {
    let project = TestProject::new("translation-loop-invariant-entry-domain");
...
fn explicit_user_invariant_rejects_unknown_obligation_kind() {
    let project = TestProject::new("translation-loop-invariant-user-unknown");
...
fn tampered_invariant_template_is_rejected() {
    let project = TestProject::new("translation-loop-invariant-template-tamper");
    let artifact_path = emit_artifact(
        &project,
...
fn valid_loop_artifact_verifies_after_invariant_checks() {
    let project = TestProject::new("translation-loop-invariant-verify");
    let artifact_path = emit_artifact(
        &project,
...
fn multiple_loops_scope_invariants_to_each_back_edge() {
    let project = TestProject::new("translation-loop-invariant-scoped");
    let artifact_path = emit_artifact(
        &project,
...
fn tampered_invariant_back_edge_states_are_replayed_from_core() {
    let project = TestProject::new("translation-loop-invariant-state-tamper");
    let artifact_path = emit_artifact(
        &project,
...
fn tampered_user_invariant_entry_states_are_replayed_from_core() {
    let project = TestProject::new("translation-loop-invariant-entry-state-tamper");
    let artifact_path = emit_artifact(
        &project,
...
fn tampered_user_invariant_fact_is_rejected_after_rehash() {
    let project = TestProject::new("translation-loop-invariant-user-fact-tamper");
    let artifact_path = emit_artifact(
        &project,
...
fn stale_user_invariant_template_fact_is_rejected_after_rehash() {
    let project = TestProject::new("translation-loop-invariant-user-template-tamper");
    let artifact_path = emit_artifact(
        &project,
