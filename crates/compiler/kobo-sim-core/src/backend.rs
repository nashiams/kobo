...
pub fn capabilities() -> &'static [BackendCapability] {
    &[
        BackendCapability {
            ...
            full_ecosystem_exploration: true,
            registered_boundary_exploration: true,
            coverage_contract: "full-compiler-owned-generated-rust",
        ...
        BackendCapability {
            ...
            full_ecosystem_exploration: true,
            registered_boundary_exploration: true,
            coverage_contract: "full-compiler-owned-loom-generated-rust",
        ...
        BackendCapability {
            ...
            full_ecosystem_exploration: true,
            registered_boundary_exploration: true,
            coverage_contract: "full-compiler-owned-storage-facade",
        ...
        BackendCapability {
            ...
            full_ecosystem_exploration: true,
            registered_boundary_exploration: true,
            coverage_contract: "full-compiler-owned-network-facade",
...
pub fn execute_profile(
    ...
    match profile {
        ...
        "async" => Some(execution(
            "shuttle",
            "generated-user-rust-adapter",
            "generated-user-rust-shuttle-scheduler",
            seed,
            semantic_trace_hash,
            harness_trace_hash,
            generated_rust_hash,
        ...
        "network" | "network-design" => Some(execution(
            "turmoil",
            "generated-user-rust-adapter",
            "generated-user-rust-loopback-network",
            seed,
            semantic_trace_hash,
            harness_trace_hash,
            generated_rust_hash,
        ...
        "distributed" | "madsim" => Some(execution(
            "madsim",
            "generated-user-rust-adapter",
            "generated-user-rust-distributed-scheduler",
            seed,
            semantic_trace_hash,
            harness_trace_hash,
            generated_rust_hash,
