...
fn kproof_records_cfg_obligation_events_envs_summaries_and_coverage_loss() {
    let artifact = run_proof_artifact("v14-proof-cfg", "proof_cfg_case", "ack");
...
fn kproof_records_replay_grade_and_adapter_confidence() {
    let artifact = run_proof_artifact("v14-proof-grade", "proof_grade_case", "ack");
...
fn kwit_proof_json_uses_same_semantic_schema() {
    let artifact = run_proof_artifact("v14-proof-kwit", "proof_kwit_case", "nack");
...
fn proof_artifact_claim_ends_at_core_until_translation_validation() {
    let artifact = run_proof_artifact("v14-proof-claim", "proof_claim_case", "requeue");
