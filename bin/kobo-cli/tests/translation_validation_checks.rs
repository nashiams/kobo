...
fn generated_rust_trace_matches_core_trace_and_validates() {
    let project = TestProject::new("translation-translation-valid");
...
fn codegen_source_map_emits_structured_lowering_trace_metadata() {
    let project = TestProject::new("translation-translation-codegen-trace");
...
fn dropped_discharge_event_fails_translation_validation() {
    let project = TestProject::new("translation-translation-dropped-discharge");
...
fn inserted_escape_event_fails_translation_validation() {
    let project = TestProject::new("translation-translation-extra-event");
...
fn meaning_changing_reorder_fails_translation_validation() {
    let project = TestProject::new("translation-translation-reorder");
...
fn stale_source_map_anchor_fails_translation_validation() {
    let project = TestProject::new("translation-translation-stale-anchor");
...
fn changed_template_version_fails_translation_validation() {
    let project = TestProject::new("translation-translation-template");
...
fn translation_status_cannot_be_toggled_without_trace_evidence() {
    let project = TestProject::new("translation-translation-status-toggle");
...
fn generated_trace_preserves_real_panic_terminator_events() {
    let project = TestProject::new("translation-translation-panic-event");
...
fn generated_trace_preserves_normal_return_events() {
    let project = TestProject::new("translation-translation-return-event");
...
fn fake_source_map_anchor_id_is_rejected_even_when_hashes_are_recomputed() {
    let project = TestProject::new("translation-translation-fake-anchor");
...
fn generated_trace_preserves_real_error_exit_terminator_events() {
    let project = TestProject::new("translation-translation-error-exit-event");
    let artifact_path = emit_artifact(
        &project,
...
fn missing_source_map_rejects_generated_trace_validation() {
    let project = TestProject::new("translation-translation-missing-map");
...
fn source_map_lowering_trace_tamper_rejects_validation() {
    let project = TestProject::new("translation-translation-lowering-trace-tamper");
...
fn source_map_extra_lowering_trace_event_rejects_validation() {
    let project = TestProject::new("translation-translation-extra-lowering-event");
...
fn source_map_lowering_trace_order_tamper_rejects_validation() {
    let project = TestProject::new("translation-translation-lowering-order-tamper");
