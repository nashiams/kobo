...
impl KErrorCode {
    pub const fn short_description(self) -> &'static str {
        match self {
            ...
            Self::K0002 => "mutable borrow overlaps another borrow",
            Self::K0020 => "shared borrow checked many times in a hot path",
            Self::K0021 => "borrow counter reached its limit",
            ...
            Self::K0031 => "engine-owned value kept directly owned",
            Self::K0032 => "move while a borrow is live needs shared ownership",
            Self::K0041 => "I need aliases to end before this strict block",
            ...
            Self::K0060 => "borrow remains live across await",
            Self::K0061 => "this async task cannot safely carry one captured value",
            Self::K0062 => "async executor dependency is missing",
            Self::K0063 => "this strict borrow is inside code that can pause",
            Self::K0064 => "strict guard remains live across await",
            ...
            Self::K0080P2 => "parent-child back-pointer tree can leak",
            ...
            Self::K0099 => "Rust reported an error in generated code",
            Self::K0100 => "checked scenario left a required action unfinished",
            Self::K0101 => "an obligation leaves the code I can check",
            Self::K0102 => "this replay path can change between runs",
            Self::K0103 => "I do not know how to replay this action yet",
            Self::K0104 => "replay witness diverged from recorded history",
            ...
            Self::K0110 => "I could not read this syntax yet",
            ...
            Self::K0120 => "I could not read ecosystem policy metadata",
